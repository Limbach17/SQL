...
INSERT INTO cheetah.subjects (route_name, subject_name , documentation_url, createdAt, updatedAt, FrameworkId, ModeratorId) 
VALUES ("jqsyntax", "jQuery Syntax", "https://www.w3schools.com/jquery/jquery_syntax.asp", now(), now(), 4, 1);

INSERT INTO cheetah.subjects (route_name, subject_name , documentation_url, createdAt, updatedAt, FrameworkId, ModeratorId) 
VALUES ("jqselectors", "jQuery Selectors", "https://www.w3schools.com/jquery/jquery_selectors.asp", now(), now(), 4, 1);
...
INSERT INTO cheetah.subjects (route_name, subject_name , documentation_url, createdAt, updatedAt, FrameworkId, ModeratorId) 
VALUES ("nodebasics", "Node.js Basics", "https://www.w3schools.com/nodejs/nodejs_intro.asp", now(), now(), 5, 1);
